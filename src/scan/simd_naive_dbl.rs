...
use crate::scan::Scan;
use crate::support::DoubleBufferMode;
use crate::support::IAdd;
use crate::support::IDisplay;
use crate::support::alloc_aligned;
use crate::support::copy_simd;
use crate::support::rotate_right_simd;

impl Scan {
    /// Implement the sequential Simd exclusive scan algorithm
    pub fn simd_naive_dbl<T, const N: usize>(
        &self,
        def: T,
        v_in: &[T],
        v_out: &mut [T],

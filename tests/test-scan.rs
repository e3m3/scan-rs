...
mod tests {
    ...
    const N15_1_OUT: [i64; 15] = [0, 18, 30, 48, 48, 67, 77, 84, 101, 101, 102, 110, 127, 145, 162];

    const N16_1_IN: [i64; 16] = [2, 2, 4, 8, 15, 12, 4, 19, 8, 11, 15, 12, 9, 17, 14, 15];
    const N16_1_OUT: [i64; 16] = [0, 2, 4, 8, 16, 31, 43, 47, 66, 74, 85, 100, 112, 121, 138, 152];

    const N100_1_IN: [i64; 100] = [
        0, 13, 6, 18, 19, 9, 3, 8, 2, 6,
        12, 13, 7, 2, 9, 17, 8, 9, 0, 14,
        5, 18, 10, 12, 5, 16, 2, 10, 5, 5,
        13, 8, 12, 18, 1, 3, 2, 10, 13, 9,
        11, 19, 2, 2, 18, 12, 2, 9, 14, 9,
        0, 8, 14, 15, 16, 2, 7, 2, 2, 15,
        13, 3, 11, 16, 7, 15, 15, 20, 1, 10,
        18, 13, 1, 4, 18, 8, 19, 3, 8, 20,
        3, 9, 14, 4, 20, 11, 0, 8, 6, 4,
        3, 19, 3, 18, 13, 0, 2, 13, 11, 11,
    ];
    const N100_1_OUT: [i64; 100] = [
        0, 0, 13, 19, 37, 56, 65, 68, 76, 78,
        84, 96, 109, 116, 118, 127, 144, 152, 161, 161,
        175, 180, 198, 208, 220, 225, 241, 243, 253, 258,
        263, 276, 284, 296, 314, 315, 318, 320, 330, 343,
        352, 363, 382, 384, 386, 404, 416, 418, 427, 441,
        450, 450, 458, 472, 487, 503, 505, 512, 514, 516,
        531, 544, 547, 558, 574, 581, 596, 611, 631, 632,
        642, 660, 673, 674, 678, 696, 704, 723, 726, 734,
        754, 757, 766, 780, 784, 804, 815, 815, 823, 829,
        833, 836, 855, 858, 876, 889, 889, 891, 904, 915,
    ];
